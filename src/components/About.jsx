...
const About = ({ Id, Img }) => {
  ...
  return (
    <div className="bg-bg_color_2 bg-opacity-20 backdrop-blur-blur1 md:w-1/2 w-11/12 h-auto sm:mx-5 mx-auto md:mx-7 py-10 px-6 md:px-16 my-20 font-urbanist font-medium leading-tight text-text_col_1 rounded-3xl">
      <img src={Img} alt="Logo" className="mx-auto w-48 h-48 mb-10" />
      <p className="text-3xl md:text-4xl my-4 font-urbanist font-bold leading-tight bg-gradient-right bg-clip-text text-transparent">
        About {Id === "1" ? Eg : Sjec}
      </p>

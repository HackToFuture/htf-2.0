...
const About = ({ Id, Img }) => {
  ...
  return (
    <div className="bg-opacity-40 sm:w-1/2 w-5/6 h-auto sm:mx-5 mx-auto p-3 my-3 font-intermed leading-tight text-text_col_1 text-center rounded-3xl backdrop-blur-blur1">

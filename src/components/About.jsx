...
const About = ({ Id, Img }) => {
  ...
  return (
    <div className="bg-bg_color_2 bg-opacity-40 backdrop-blur-blur1 sm:w-1/2 w-5/6 h-auto sm:mx-5 mx-auto py-10 px-16 my-3 font-intermed leading-tight text-text_col_1 rounded-3xl">

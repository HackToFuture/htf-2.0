...
const Faq = () => {
  ...
  return (
    <div className=" p-6 w-full shadow-md flex flex-col items-start ">
      <div className="text-3xl text-center font-interbold bg-gradient-right bg-clip-text text-transparent mx-auto">
      ...
      <div className="flex flex-col w-full items-start mt-4 mx-auto max-w-screen-md">
        {faqData.map((faq, index) => (
          <div key={index} className="w-full mb-4">
            ...
            {selectedQuestion === index && (
              <p className=" bg-bg_color_2 bg-opacity-40 backdrop-blur-blur1 pt-2  pb-3 px-7 rounded-b-lg text-text_col_1 text-base font-intermed leading-tight">
                {faq.answer}
              </p>
            )}
          </div>
